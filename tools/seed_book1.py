...
DATA = os.path.join(os.path.dirname(__file__), "book1_words.json")
...
db.commit()
db.close()
print(f"Done. Book 1: {total} words across {len(data)} units (no images).")
